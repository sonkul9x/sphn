<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'SK Option', 'redux-framework-demo' ),
        'page_title'           => __( 'SK Option', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'basic',
        'desc'             => __( 'Cài đặt những thông tin cơ bản tại tại website!', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'Cài đặt Header Cơ bản ', 'redux-framework-demo'),
        'fields'           => array(
              array(
                'id'       => 'Logo',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề trang', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Text mặc định nếu không có logo', 'redux-framework-demo' ),
                'default'  => ' ',
            ),
            array(
                'id'       => 'opt-media',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Logo Website', 'redux-framework-demo' ),
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'     => __( 'Logo website.', 'redux-framework-demo' ),
