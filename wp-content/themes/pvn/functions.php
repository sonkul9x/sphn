...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'menu-footer' => __('Menu sidebar', 'html5blank'), // Main Navigation   
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'after_widget' => '</div>',
        'before_title' => '<h3 class="title-sidebar"><span>',
        'after_title' => '</span></h3>'
    ));

    // Define Sidebar Widget Area 2
    register_sidebar(array(
        'name' => __('Vị trí Sidebar Phải', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id'            => 'sidebar-right',
        'before_widget' => '<div id="%1$s" class="sidebarbox ttvcs">',
        'after_widget' => '</div>',
        'before_title' => '<div class="title-sidebar">',
        'after_title' => '</div>'
    ));
}
...
class Random_Post extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        if ($random_query->have_posts()):
            echo '<div class="contents-sidebarbox"><ul>';
            while( $random_query->have_posts() ) :
                $random_query->the_post(); ?>
 
                <li>
                <a href="#" class="img-tt"><?php the_post_thumbnail('img-1'); ?></a>
...
//require_once (THEME_BASE_DIR . '/inc/create-single-template.php');
